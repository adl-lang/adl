...
runTests = do
  ...
  describe "adlc verify backend" $ do
    ...
    it "succeeds for correctly numbered versions of a name" $ do
      runVerifyBackend1 "test10/input/test10.adl"
