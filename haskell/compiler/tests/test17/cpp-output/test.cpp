...
Serialisable<ADL::test::X2>::serialiser( const SerialiserFlags &sf )
{
    ...
    struct S_ : public Serialiser<_T>
    {
        ...
        mutable typename Serialiser<ADL::test::Pair<std::string,int32_t> >::Ptr f3_;
        mutable typename Serialiser<ADL::test::Pair<std::string,std::string> >::Ptr f4_;
        mutable typename Serialiser<std::vector<int32_t> >::Ptr f5_;
        mutable typename Serialiser<std::vector<ADL::test::Pair<std::string,int32_t> > >::Ptr f6_;
        mutable typename Serialiser<std::vector<ADL::test::Pair<std::string,std::string> > >::Ptr f7_;
        ...
        typename Serialiser<ADL::test::Pair<std::string,int32_t> >::Ptr f3_s() const
        {
            if( !f3_ )
                f3_ = Serialisable<ADL::test::Pair<std::string,int32_t> >::serialiser(sf_);
            return f3_;
        }
        
        typename Serialiser<ADL::test::Pair<std::string,std::string> >::Ptr f4_s() const
        {
            if( !f4_ )
                f4_ = Serialisable<ADL::test::Pair<std::string,std::string> >::serialiser(sf_);
            return f4_;
        }
        ...
        typename Serialiser<std::vector<ADL::test::Pair<std::string,int32_t> > >::Ptr f6_s() const
        {
            if( !f6_ )
                f6_ = Serialisable<std::vector<ADL::test::Pair<std::string,int32_t> > >::serialiser(sf_);
            return f6_;
        }
        
        typename Serialiser<std::vector<ADL::test::Pair<std::string,std::string> > >::Ptr f7_s() const
        {
            if( !f7_ )
                f7_ = Serialisable<std::vector<ADL::test::Pair<std::string,std::string> > >::serialiser(sf_);
            return f7_;
        }
        ...
        void toJson( JsonWriter &json, const _T & v ) const
        {
            ...
            switch( v.d() )
            {
                case ADL::test::X2::F1: writeField( json, f1_s(), "f1", v.f1() ); break;
                case ADL::test::X2::F2: writeField( json, f2_s(), "f2", v.f2() ); break;
                case ADL::test::X2::F3: writeField( json, f3_s(), "f3", v.f3() ); break;
                case ADL::test::X2::F4: writeField( json, f4_s(), "f4", v.f4() ); break;
                case ADL::test::X2::F5: writeField( json, f5_s(), "f5", v.f5() ); break;
                case ADL::test::X2::F6: writeField( json, f6_s(), "f6", v.f6() ); break;
                case ADL::test::X2::F7: writeField( json, f7_s(), "f7", v.f7() ); break;
            }
            json.endObject();
        }
...
Serialisable<ADL::test::X1>::serialiser( const SerialiserFlags &sf )
{
    ...
    struct S_ : public Serialiser<_T>
    {
        S_( const SerialiserFlags & sf )
            ...
            , f2_s( Serialisable<ADL::test::T1>::serialiser(sf) )
            , f3_s( Serialisable<ADL::test::T2<std::string> >::serialiser(sf) )
            , f4_s( Serialisable<ADL::test::T3<std::string,std::string> >::serialiser(sf) )
            , f5_s( Serialisable<std::vector<int32_t> >::serialiser(sf) )
            , f6_s( Serialisable<std::vector<ADL::test::Pair<std::string,int32_t> > >::serialiser(sf) )
            , f7_s( Serialisable<std::vector<ADL::test::Pair<std::string,std::string> > >::serialiser(sf) )
            {}
        
        
        typename Serialiser<int32_t>::Ptr f1_s;
        typename Serialiser<ADL::test::T1>::Ptr f2_s;
        typename Serialiser<ADL::test::T2<std::string> >::Ptr f3_s;
        typename Serialiser<ADL::test::T3<std::string,std::string> >::Ptr f4_s;
        typename Serialiser<std::vector<int32_t> >::Ptr f5_s;
        typename Serialiser<std::vector<ADL::test::Pair<std::string,int32_t> > >::Ptr f6_s;
        typename Serialiser<std::vector<ADL::test::Pair<std::string,std::string> > >::Ptr f7_s;
        
        void toJson( JsonWriter &json, const _T & v ) const
        {
            json.startObject();
            writeField<int32_t>( json, f1_s, "f1", v.f1 );
            writeField<ADL::test::T1>( json, f2_s, "f2", v.f2 );
            writeField<ADL::test::T2<std::string> >( json, f3_s, "f3", v.f3 );
            writeField<ADL::test::T3<std::string,std::string> >( json, f4_s, "f4", v.f4 );
            writeField<std::vector<int32_t> >( json, f5_s, "f5", v.f5 );
            writeField<std::vector<ADL::test::Pair<std::string,int32_t> > >( json, f6_s, "f6", v.f6 );
            writeField<std::vector<ADL::test::Pair<std::string,std::string> > >( json, f7_s, "f7", v.f7 );
            json.endObject();
        }
