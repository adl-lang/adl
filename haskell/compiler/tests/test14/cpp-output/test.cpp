...
typename Serialiser<ADL::test::switch_>::Ptr
Serialisable<ADL::test::switch_>::serialiser( const SerialiserFlags &sf )
{
    typedef ADL::test::switch_ _T;
...
typename Serialiser<ADL::test::unsigned_>::Ptr
Serialisable<ADL::test::unsigned_>::serialiser( const SerialiserFlags &sf )
{
    typedef ADL::test::unsigned_ _T;
