...
typename Serialiser<ADL::test2::S0>::Ptr
Serialisable<ADL::test2::S0>::serialiser( const SerialiserFlags &sf )
{
    typedef ADL::test2::S0 _T;
...
typename Serialiser<ADL::test2::S1>::Ptr
Serialisable<ADL::test2::S1>::serialiser( const SerialiserFlags &sf )
{
    typedef ADL::test2::S1 _T;
...
typename Serialiser<ADL::test2::S2>::Ptr
Serialisable<ADL::test2::S2>::serialiser( const SerialiserFlags &sf )
{
    typedef ADL::test2::S2 _T;
