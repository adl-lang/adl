...
template <class T>
struct Serialisable<ADL::test::S3<T>>
{
    static typename Serialiser<ADL::test::S3<T>>::Ptr serialiser(const SerialiserFlags &);
};

template <class T>
typename Serialiser<ADL::test::S3<T>>::Ptr
Serialisable<ADL::test::S3<T>>::serialiser( const SerialiserFlags &sf )
{
    typedef ADL::test::S3<T> _T;
...
template <class T>
struct Serialisable<ADL::test::S4<T>>
{
    static typename Serialiser<ADL::test::S4<T>>::Ptr serialiser(const SerialiserFlags &);
};

template <class T>
typename Serialiser<ADL::test::S4<T>>::Ptr
Serialisable<ADL::test::S4<T>>::serialiser( const SerialiserFlags &sf )
{
    typedef ADL::test::S4<T> _T;
    
    struct S_ : public Serialiser<_T>
    {
        S_( const SerialiserFlags & sf )
            : f1_s( Serialisable<ADL::test::S3<std::string> >::serialiser(sf) )
            , f2_s( Serialisable<ADL::test::S3<T> >::serialiser(sf) )
            {}
        
        
        typename Serialiser<ADL::test::S3<std::string> >::Ptr f1_s;
        typename Serialiser<ADL::test::S3<T> >::Ptr f2_s;
        
        void toJson( JsonWriter &json, const _T & v ) const
        {
            json.startObject();
            writeField<ADL::test::S3<std::string> >( json, f1_s, "f1", v.f1 );
            writeField<ADL::test::S3<T> >( json, f2_s, "f2", v.f2 );
            json.endObject();
        }
