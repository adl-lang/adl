import {TypeRef, isJsonParseException, jsonParseException, exceptionOn} from './adl';
...
/**
 * Primitive field type (e.g. String, Double, Int32,...)
 */
interface Primitive {
  primitive: string;
}
...
// TODO(jeeva): review this properly
export class JsonBindings {
  ...
  serialise<T>(value: T, type: TypeRef<T>): {}|null {
  ...
  validatePrimitiveType(json: {}, primitiveName: string, defaultv?: {}|null): {}|null {
    ...
    if (primitiveName === 'Double' || primitiveName === 'Int32' || primitiveName === 'Int64' || primitiveName === 'Int8' || primitiveName === 'Float') {
