...
adlcb -O runtime/src $ADL_STDLIB_DIR/sys/package.adl
...
stack exec adlc -- typescript \
 ...
 -I $ADL_STDLIB_DIR \
 $ADL_STDLIB_DIR/sys/types.adl $ADL_STDLIB_DIR/sys/adlast.adl $ADL_STDLIB_DIR/sys/package.adl $ADL_STDLIB_DIR/sys/dynamic.adl
 stack exec adlc -- typescript \
 --no-overwrite \
 --exclude-ast \
 --verbose \
