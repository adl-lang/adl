...
module ADL.Compiler.Compiler where
...
haskell :: HaskellFlags -> ([FilePath] -> EIOT H.CustomTypeMap) -> [FilePath] -> EIOT ()
haskell hf getCustomTypes modulePaths = catchAllExceptions $ forM_ modulePaths $ \modulePath -> do
