...
impl<'de> Deserialize<'de> for CDate {
        ...
        D: Deserializer<'de>
    {
      ...
      Ok(CDate(NaiveDate::from_ymd(cdate0.year as i32, cdate0.month as u32, cdate0.day as u32)))
    }
}

pub mod cdatehelpers {
  pub fn new(year: i16, month: i16, day: i16) -> super::CDate {
    super::CDate(super::NaiveDate::from_ymd(year as i32, month as u32, day as u32))
  }
}
